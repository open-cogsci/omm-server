      ...
      <div class="row">
        <div class="col col-12">
          <h1 class="text-h5 text-md-h4 font-weight-light">
            layout.nav.participants
          </h1>
        </div>
      </div>
      <div class="row">
        <div class="col col-12">
          <div class="v-input v-input--hide-details theme--light v-text-field v-text-field--single-line v-text-field--solo v-text-field--enclosed v-text-field--placeholder">
            <div class="v-input__control">
              <div class="v-input__slot">
                ...
                <div class="v-text-field__slot">
                  <input id="input-5" placeholder="participants.search" type="text">
                </div>
